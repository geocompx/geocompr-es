...
However, we recommend reading about the wider context of *Geocomputación con R* in Chapter \@ref(intro) first.
...
*Geocomputación con R* will equip you with knowledge and skills to tackle a wide range of issues, including those with scientific, societal and environmental implications, manifested in geographic data.
...
The final thank you is for all the software developers who make Geocomputación con R possible.
